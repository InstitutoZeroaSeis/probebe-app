...
var app = angular.module("proBebe", ["ionic", "proBebe.controllers", "proBebe.services", "proBebe.factories",  "proBebe.directives", "ngCordovaOauth", "ngSanitize"]).run(function($timeout, $ionicPlatform, $rootScope, $state, $ionicLoading, authentication, pushProcessing, Microdonation, ObserverMicrodonation, messageHandler, storage) {
